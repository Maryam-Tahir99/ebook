...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2020 at 01:46 PM
...
CREATE TABLE `books` (
  ...
  `books_link` varchar(200) COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
INSERT INTO `library` (`ID`, `book_title`) VALUES
(1, 'The Bride (Lairds\' Fiancees #1)'),
(1, 'The Bride (Lairds\' Fiancees #1)'),
(1, 'The Bride (Lairds\' Fiancees #1)'),
(1, 'The Bride (Lairds\' Fiancees #1)');
